                ...
                <form  onSubmit={handleSubmit} className="p-4 p-md-5 bg-light rounded"
                    ...
                    <div className="form-floating text-muted mb-3">
                        <input type="text" className="form-control form-control-lg" id="name" name="name"
                            placeholder="Nome do Aluno" required onChange={handleChange} />
                    ...
                    <div className="form-floating text-muted mb-3">
                        <input type="tel" className="form-control form-control-lg" id="phone" name="phone" placeholder="Telefone" required onChange={handleChange} />
                    ...
                    <button className="w-100 btn btn-lg btn-primary mt-3" type="submit">Cadastrar Aluno</button>
                    <Link to={"/register"}>
